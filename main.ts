...
export async function run(root: HTMLElement): Promise<void> {
  ...
  await mountTaskApp({
    root,
    task_id: "H000028-weather-prediction",
    task_name: "Weather Prediction Task",
    task_description: "HTML preview aligned to local psyflow Weather Prediction procedure and parameters.",
    settings,
    subInfo,
    stimBank,
              ...
              [
                (_snapshot: TrialSnapshot, runtime: RuntimeView) => {
                  ...
                  return stimBank.get_and_format("block_break", {
                    ...
                    sun_prediction_rate: summary.sun_prediction_rate,
